...
uint256 hashGenesisBlock("0x1f9189be3a21b11bdfd80912191cc6e79bd1214fdbb266b67da4ed00fdd7fae8");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // TranservCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "TranservCoin Signed Message:\n";
...
{
    // TranservCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // TranservCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 500; // TranservCoin: 3.5 days
static const int64 nTargetSpacing = 40; // TranservCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // TranservCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // TranservCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // TranservCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe73cfa71e5a98921359781cc2312f25e0a8cafeb11442fcfa2ff9646518bb711");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Crpto-Dev by Decentralized Earth";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("bb6861c4adf8a90cf3fcc7f5b11b221f440bbeea359badf2e8d86194bc76ad92cc3ef2fb89c8a0781f498014b8037214a54a912453078701abad72cc76becb4732") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1506846487;
        block.nBits    = 504365644;
        block.nNonce   = 4248289986;

        if (fTestNet)
        {
            block.nTime    = 1506846487;
            block.nNonce   = 3978906761;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x34a00b7e905d112edf978dc6e5e939bfd71be33b0a59de0c23f7a7de88d42cf9"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // TranservCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TranservCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TranservCoinMiner : ProcessBlock, block not accepted");
    }
